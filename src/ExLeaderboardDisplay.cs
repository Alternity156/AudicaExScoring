...
namespace ExScoringMod
{
    public partial class ExScoring : MelonMod
    {
        ...
        public static class OnlineLeaderboardUpdateLeaderboardPatch
        {
            ...
            {
                MelonLogger.Log($"[ExScoring] UpdateLeaderboard called: mode={mode} leaderboardID={leaderboardID} ExType={Config.ExType}");
                ...
                FetchLeaderboard(songId, difficulty, rowLimit, response =>
                {
